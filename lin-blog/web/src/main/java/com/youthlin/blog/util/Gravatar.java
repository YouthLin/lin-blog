...
public final class Gravatar {
    public static final String PREFIX = "https://cn.gravatar.com/avatar/";
    ...
    private String type = null;//默认头像类型，和默认头像 URL 不能共存
    ...
    public static Gravatar withEmail(String email) {
        return withHash(MD5Util.md5(email));
    }
    ...
    public static String getUrlWithEmail(String email) {
        return PREFIX + MD5Util.md5(email);
    }
