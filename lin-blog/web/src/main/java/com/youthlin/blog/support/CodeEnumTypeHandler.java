 ...
 * <p>
 * 通用枚举处理
 * 在 mybatis-config.xml 中配置如下:
 * <ul>
 * <li>必须指定 javaType 枚举类
 * <li>枚举类必须包含实例方法 {@code int getCode()} 和静态的{@code codeOf(int)} 方法
 * </ul>
 * <pre>
 * &lt;typeHandlers&gt;
 ...
 * &lt;/typeHandlers&gt;
 * </pre>
 * TypeHandler 初始化参考 {@link org.apache.ibatis.builder.xml.XMLConfigBuilder} 中方法 typeHandlerElement
 *
...
public class CodeEnumTypeHandler extends BaseTypeHandler<Enum<?>> {
    ...
    private Integer getCode(Enum object) {
        try {
